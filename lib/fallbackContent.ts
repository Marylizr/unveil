...
export const fallbackProducts: Product[] = [
  {
    _id: "fallback-understanding-female-pleasure",
    title: text("Understanding Female Pleasure"),
    slug: "understanding-female-pleasure",
    shortDescription: text("A refined educational guide to communication, anatomy literacy, emotional safety, and attentive intimacy."),
    fullDescription: text("A respectful digital guide for adults who want to learn about pleasure, trust, consent, and communication with maturity."),
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dnaq4a9do/image/upload/v1780686890/Understanding-Female-Pleasure_snjn8t.png",
        alt: "Understanding Female Pleasure digital guide cover by UNVEIL",
        position: 0,
      },
    ],
    ...
    benefits: ["Builds anatomy literacy", "Supports emotional safety", "Encourages mature communication"],
    howToUse: ["Read one chapter at a time", "Use the prompts for private reflection", "Return to communication sections as needed"],
  ...
  {
    _id: "fallback-the-art-of-connection",
    title: text("The Art of Connection"),
    slug: "the-art-of-connection",
    shortDescription: text("A concise digital guide to presence, communication, confidence, and emotionally intelligent dating."),
    fullDescription: text("A refined guide to connection, boundaries, emotional maturity, and calm confidence without manipulation or performance pressure."),
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dnaq4a9do/image/upload/v1780686886/The-Art-of_Connection_fdnzfk.png",
        alt: "The Art of Connection digital guide cover by UNVEIL",
        position: 0,
      },
    ],
    stockStatus: "in_stock",
    sku: "UNV-ART-CONNECTION",
    tags: ["Digital", "Guide", "Connection"],
    benefits: ["Builds presence", "Supports honest communication", "Encourages consent and boundaries"],
    howToUse: ["Read before reflection or journaling", "Use prompts to prepare for real conversations", "Return to repair and boundary sections when needed"],
    materials: ["Protected PDF ebook"],
    careInstructions: ["Store in your private digital library"],
    safetyNotes: ["Educational content only", "Not dating manipulation advice"],
    fulfillmentType: "digital",
    isFeatured: true,
    isPublished: true,
    publicationStatus: "published",
  },
  {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dnaq4a9do/image/upload/v1780686886/The-Modern-Man_Code_h0qup0.png",
        alt: "The Modern Man Code digital guide cover by UNVEIL",
        position: 0,
      },
    ],
    stockStatus: "in_stock",
