...
export default function ProductCatalogExperience() {
  ...
  return (
    <div className="min-h-screen bg-deep pt-24">
      <div className="mx-auto max-w-7xl px-6 py-16">
        <header className="mb-14 max-w-3xl">
          <p className="mb-4 font-sans text-xs uppercase tracking-[0.3em] text-mist/60">UNVEIL resources</p>
          <h1 className="font-serif text-6xl leading-tight text-cream md:text-8xl">Tools for informed self-care</h1>
          <p className="mt-5 max-w-xl font-sans text-base leading-relaxed text-sage/75">
        ...
        {status === "loading" && (
          <div className="border border-forest/40 p-10 font-sans text-sm text-sage">Preparing the resource catalog.</div>
        )}

        {status === "error" && (
          <div className="border border-forest/40 p-10">
            <h2 className="font-serif text-3xl text-cream">The catalog is temporarily unavailable.</h2>
            <p className="mt-3 font-sans text-sm leading-relaxed text-sage/70">
