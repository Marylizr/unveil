...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body>
        <main className="min-h-screen bg-deep px-6 pt-32 text-cream">
          <section className="mx-auto max-w-2xl border border-forest/50 bg-forest/20 p-8">
            ...
            <h1 className="font-serif text-5xl leading-tight">The app needs a reset.</h1>
            <p className="mt-5 font-sans text-sm leading-relaxed text-sage/75">
              A global error occurred while loading UNVEIL.
            </p>
